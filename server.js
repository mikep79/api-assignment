...
app.get('/giphy', function(req, res){
    ...
    // };
    // var url = 'https://api.giphy.com/v1/gifs/search?api_key=iffydHwQsYZmNA4JmRNpn46K8F3P7NNb&q=rubber duckies&limit=25&offset=0&rating=G&lang=en';
    var url = 'https://api.giphy.com/v1/gifs/random?api_key=iffydHwQsYZmNA4JmRNpn46K8F3P7NNb&tag=loony&rating=PG';
